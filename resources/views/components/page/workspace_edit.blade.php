<x-lte::layout.v1.page>
    <x-lte::card.header>
        <div class="flex border grow justify-between px-2">
            ...
            <a href="{{route('builder.page', \Modules\View\Models\ModuleEntityPageModel::where('name', 'Workspaces Form')->first())}}"
               class="border rounded p-2 my-auto" title="Builder">
    ...
    <x-lte::card.body>
        ...
        <livewire:view-structure::form.dynamic-form :model="$workspace"/>
        {{--
